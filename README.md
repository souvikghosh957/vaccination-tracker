...
<div> 6) Upload and update records can only be done by an administrative user. Fetching a person, family or area details can be be done by both administrative and
  or general users </div>
<div> 7) The individual service also can be containerized.
