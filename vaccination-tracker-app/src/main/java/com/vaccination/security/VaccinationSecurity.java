...
public class VaccinationSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/vaccination/uploadRecords", "/vaccination/updateVaccination").hasAnyRole("ADMIN")
		.antMatchers("/vaccination/getPersonVaccinationDetails?**").hasAnyRole("ADMIN", "USER")
